...
feature 'Seo defaults feature', %q{
  ...
  scenario 'setting seo defaults for blog page' do

    # given there is a default for the title in the blog page
    FactoryGirl.create  :seo_default,
                        :object_type => 'BlogPage',
                        :object_attribute => 'webtitle',
  ...
  scenario 'visiting the book page when the SEO defaults have been set and we set a custom seo for title' do
    ...
    FactoryGirl.create(:seo_info, :infoable => @book, :title => 'Custom Kawaii title')
  ...
  scenario 'setting SEO defaults for the PDF landing page' do
    ...
    FactoryGirl.create(:download_format, :book => @book)
  ...
  scenario 'visiting the mp3 landing page when SEO defaults have been set' do
    ...
    @audiobook = FactoryGirl.create(:audiobook, :pretty_title => 'Kawaii Sound', :author => @author)

    #And there is a slug for the mp3 landing page:
    @mp3_slug = FactoryGirl.create(:seo_slug, :seoable => @audiobook, :slug => 'download-kawaii-sound-mp3', :format => 'mp3')
  ...
  scenario 'visiting read online landing page when SEO defaults have been set' do
    ...
    @read_online_slug = FactoryGirl.create(:seo_slug, :seoable => @book, :slug => 'read-kawaii-online-free', :format => 'online')
